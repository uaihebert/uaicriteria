...
public class MethodsJoinInnerFetchTest extends AbstractTest {
    ...
    public void isMultipleJoin1LevelWorking() {
        ...
        final String query = "select t2 from RegularEntityTwo t2 join fetch t2.regularEntityOne where t2.regularEntityOne.stringAttribute = '" + VALUE_STRING_01 + "'";
