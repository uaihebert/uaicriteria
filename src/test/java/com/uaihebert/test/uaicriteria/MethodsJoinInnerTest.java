...
public class MethodsJoinInnerTest extends AbstractTest {
    private static final String VALUE_STRING_01 = "Just a String 01";

    @Test
    public void isMultipleJoin1LevelWorking() {
        final String query = "select t2 from RegularEntityTwo t2 inner join t2.regularEntityOne t1 where t1.stringAttribute = '" + VALUE_STRING_01 + "'";
    ...
    public void isMultipleJoin2LevelWorking() {
        final String query = "select t3 " +
                ...
                "inner join t3.regularEntityTwo t2 " +
                "inner join t2.regularEntityOne t1 " +
    ...
    public void isMultipleJoin3LevelWorking() {
        final String query = "select t4 " +
                ...
                "inner join t4.regularEntityThree t3 " +
                "inner join t3.regularEntityTwo t2 " +
                "inner join t2.regularEntityOne t1 " +
                " where t1.stringAttribute = '" + VALUE_STRING_01 + "'";
