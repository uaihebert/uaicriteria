...
public class CommonTestsCalendarTestCTOImp extends AbstractTest implements CommonTests {
    ...
    public void isAddingOneOrEquals() {
        ...
        cto.orEquals("calendarAttributeOne", parameterMap.get("calendarAttribute0")).orEquals("calendarAttributeOne", parameterMap.get("calendarAttribute1"));
    ...
    public void isAddingOneWhereEquals() {
        ...
        final UaiCriteria<RegularEntityOne> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.andEquals("calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isAddingSequentialWhereEquals() {
        ...
        final UaiCriteria<RegularEntityOne> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.andEquals("calendarAttributeOne", parameterMap.get("calendarAttribute0")).andEquals("id", 1);
    ...
    public void isBetweenWorking() {
        ...
        final UaiCriteria<RegularEntityOne> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.andBetween("calendarAttributeOne", parameterMap.get("calendarAttribute0"), parameterMap.get("calendarAttribute1"));
    ...
    public void isGreaterOrEqualToWorking() {
        ...
        final UaiCriteria<RegularEntityOne> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.andGreaterOrEqualTo("calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isLessThanWorking() {
        ...
        final UaiCriteria<RegularEntityOne> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.andLessThan("calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isLessOrEqualToWorking() {
        ...
        final UaiCriteria<RegularEntityOne> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.andLessOrEqualTo("calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isGreaterThanWorking() {
        ...
        final UaiCriteria<RegularEntityOne> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.andGreaterThan("calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isJoinBetweenWorking() {
        ...
        cto.andBetween("regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"), parameterMap.get("calendarAttribute1"));
    ...
    public void isJoinGreaterOrEqualToWorking() {
        ...
        final UaiCriteria<RegularEntityTwo> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.innerJoin("regularEntityOne");
        cto.andGreaterOrEqualTo("regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isJoinLessThanWorking() {
        ...
        final UaiCriteria<RegularEntityTwo> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.innerJoin("regularEntityOne");
        cto.andLessThan("regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isJoinLessOrEqualToWorking() {
        ...
        final UaiCriteria<RegularEntityTwo> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.innerJoin("regularEntityOne");
        cto.andLessOrEqualTo("regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isJoinGreaterThanWorking() {
        ...
        final UaiCriteria<RegularEntityTwo> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.innerJoin("regularEntityOne");
        cto.andGreaterThan("regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isMultipleJoinWithBetweenWorking() {
        ...
        cto.andBetween("regularEntityThree.regularEntityTwo.regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"), parameterMap.get("calendarAttribute1"));
    ...
    public void isMultipleJoinWithGreaterOrEqualToWorking() {
        ...
        final UaiCriteria<RegularEntityFour> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.innerJoin("regularEntityThree.regularEntityTwo.regularEntityOne");
        cto.andGreaterOrEqualTo("regularEntityThree.regularEntityTwo.regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isMultipleJoinWithLessThanWorking() {
        ...
        final UaiCriteria<RegularEntityFour> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.innerJoin("regularEntityThree.regularEntityTwo.regularEntityOne");
        cto.andLessThan("regularEntityThree.regularEntityTwo.regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isMultipleJoinWithLessOrEqualToWorking() {
        ...
        final UaiCriteria<RegularEntityFour> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.innerJoin("regularEntityThree.regularEntityTwo.regularEntityOne");
        cto.andLessOrEqualTo("regularEntityThree.regularEntityTwo.regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isMultipleJoinWithGreaterThanWorking() {
        ...
        final UaiCriteria<RegularEntityFour> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.innerJoin("regularEntityThree.regularEntityTwo.regularEntityOne");
        cto.andGreaterThan("regularEntityThree.regularEntityTwo.regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"));
    ...
    public void isMultipleJoinWithOrWorking() {
        ...
        final UaiCriteria<RegularEntityFour> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.innerJoin("regularEntityThree.regularEntityTwo.regularEntityOne");
        cto.orEquals("regularEntityThree.regularEntityTwo.regularEntityOne.calendarAttributeOne", parameterMap.get("calendarAttribute0"), parameterMap.get("calendarAttribute1"));
