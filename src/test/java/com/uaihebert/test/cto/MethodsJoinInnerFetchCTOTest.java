...
public class MethodsJoinInnerFetchCTOTest extends AbstractTest {
    ...
    public void isMultipleJoin1LevelWorking() {
        ...
        uaiCriteria.innerJoinFetch("regularEntityOne");
        ...
        cto.innerJoinFetch("regularEntityOne");
    ...
    public void isMultipleJoin2LevelWorking() {
        ...
        uaiCriteria.innerJoinFetch("regularEntityTwo.regularEntityOne");
        ...
        cto.innerJoinFetch("regularEntityTwo.regularEntityOne");
    ...
    public void isMultipleJoin3LevelWorking() {
        ...
        uaiCriteria.innerJoinFetch("regularEntityThree.regularEntityTwo.regularEntityOne");
        ...
        cto.innerJoinFetch("regularEntityThree.regularEntityTwo.regularEntityOne");
