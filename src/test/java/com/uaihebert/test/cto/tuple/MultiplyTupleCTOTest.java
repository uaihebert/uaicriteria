...
public class MultiplyTupleCTOTest extends TupleAbstractTest {
    ...
    public void isMethodInvokedWithTwoParameters() {
        ...
        uaiCriteria.addTupleSelectAttribute("id").multiply("id", "longAttributeOne");

        final UaiCriteria<RegularEntityOne> cto = UaiCriteriaFactory.createQueryUaiCTO();
        cto.addTupleSelectAttribute("id").multiply("id", "longAttributeOne");
