...
public class MethodsJoinLeftCTOTest extends AbstractTest {
    ...
    public void isMultipleJoin2LevelWorking() {
        ...
        cto.leftJoin("regularEntityTwo.regularEntityOne");
    ...
    public void isMultipleJoin3LevelWorking() {
        ...
        cto.leftJoin("regularEntityThree.regularEntityTwo.regularEntityOne");
